...
extension Data4LifeDITestContainer {
    func registerDependencies() {
        ...
        register(scope: .containerInstance) { (_) -> SDKVersionValidatorType in
            ...
            Bundle.current
        }.register(scope: .containerInstance) { (_) -> ImageResizer in
            ImageResizerMock()
        ...
        }.register(scope: .containerInstance) { (_) -> RecordServiceParameterBuilderProtocol in
            RecordServiceParameterBuilderMock()
