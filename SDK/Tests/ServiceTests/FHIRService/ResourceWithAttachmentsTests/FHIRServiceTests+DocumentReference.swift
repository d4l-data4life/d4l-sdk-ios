...
class FhirStu3ServiceDocumentReferenceTests: XCTestCase {
    ...
    func testCreateDocumentReferenceResource() {
        ...
        let fixtureDocumentReference = FhirFactory.createDocumentReferenceResource()
...
extension FhirStu3ServiceAttachmentOperationsTests {
    ...
    func testDownloadDocumentReferenceResources() {
        ...
        let firstResource = FhirFactory.createDocumentReferenceResource(with: [firstAttachment])
        ...
        let secondResource = FhirFactory.createDocumentReferenceResource(with: [secondAttachment])
