...
extension ModelsR4.QuestionnaireItem: NSCopying {
    public func copy(with zone: NSZone? = nil) -> Any {
        return ModelsR4.QuestionnaireItem.init(answerOption: answerOption,
...
extension ModelsR4.QuestionnaireItemInitial: NSCopying {
    public func copy(with zone: NSZone? = nil) -> Any {
        return ModelsR4.QuestionnaireItemInitial.init(extension: self.extension,
                                                      id: id,
                                                      modifierExtension: modifierExtension,
                                                      value: value)
...
extension ModelsR4.QuestionnaireResponseItemAnswer: NSCopying {
    public func copy(with zone: NSZone? = nil) -> Any {
        return ModelsR4.QuestionnaireResponseItemAnswer.init(extension: self.extension,
                                                             id: self.id,
                                                             item: self.item,
                                                             modifierExtension: self.extension,
                                                             value: self.value)

    }
}

extension ModelsR4.QuestionnaireResponseItem: NSCopying {
    public func copy(with zone: NSZone? = nil) -> Any {
        return ModelsR4.QuestionnaireResponseItem.init(answer: self.answer,
                                                       definition: self.definition,
                                                       extension: self.extension,
                                                       id: self.id,
                                                       item: self.item,
                                                       linkId: self.linkId,
                                                       modifierExtension: self.modifierExtension,
                                                       text: self.text)
    }
}
